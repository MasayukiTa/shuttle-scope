...
$plan  = "$out\sam3_enc_fp16_attnfp32.plan"
if (Test-Path $plan) { Remove-Item $plan }
# Pin all attention subgraph + all LayerNorm + ConvTranspose to fp32; MLP/proj matmuls stay fp16
$lp = "*/attn/*:fp32,*norm*/LayerNormalization:fp32,*ln_pre*:fp32,/convs.0/dconv_2x2_0/ConvTranspose:fp32,/convs.0/dconv_2x2_1/ConvTranspose:fp32,/convs.1/dconv_2x2/ConvTranspose:fp32"
