...
try:
    ...
    with open(os.environ.get("SAM3_PLAN", BENCH + "/sam3_enc_518_fix_notactic.plan"), "rb") as f, trt.Runtime(TRT_LOGGER) as rt:
    ...
    np.savez(BENCH+"/bf16/masks_frame0_mine.npz",
    ...
    with open(os.environ.get("SAM3_OUT", BENCH + "/bf16/hybrid_mine_result.json"), "w") as f:
