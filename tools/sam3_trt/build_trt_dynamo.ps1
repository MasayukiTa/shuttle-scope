...
$onnx = "$bench\sam3_enc_518_dynamo.onnx"
$plan = "$bench\sam3_enc_518_dynamo_fp16.plan"
& "C:\TensorRT\TensorRT-10.16.1.11\bin\trtexec.exe" --onnx=$onnx --saveEngine=$plan --fp16 --memPoolSize=workspace:4096 2>&1 | Select-Object -Last 20
