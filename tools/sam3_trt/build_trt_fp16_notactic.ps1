...
$plan = "$bench\sam3_enc_518_fix_fp16_notactic.plan"
& "C:\TensorRT\TensorRT-10.16.1.11\bin\trtexec.exe" --onnx=$onnx --saveEngine=$plan --fp16 --tacticSources=-CUBLAS,-CUBLAS_LT,-CUDNN --memPoolSize=workspace:4096 2>&1 | Select-Object -Last 20
