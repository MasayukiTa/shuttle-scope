...
$plan = "$bench\sam3_enc_518_fix_opt0.plan"
& "C:\TensorRT\TensorRT-10.16.1.11\bin\trtexec.exe" --onnx=$onnx --saveEngine=$plan --builderOptimizationLevel=0 --memPoolSize=workspace:4096 2>&1 | Select-Object -Last 20
