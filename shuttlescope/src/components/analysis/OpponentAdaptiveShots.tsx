    ...
    <div className="space-y-3">
      ...
      <div className="flex flex-wrap gap-1">
        {opponents.map(o => (
          ...
          >
            {o.opponent_name}
            <span className="ml-1" style={{ color: (selected === null ? opponents[0].opponent_id : selected) === o.opponent_id ? '#ffffff' : '#9ca3af' }}>({t('auto._shared.n_matches', { n: o.match_count })})</span>
          </button>
        ))}
      </div>
