  ...
  desktop_annotator: {
    ...
    steps: [
      { title: 'Mode タブで作業領域を切替',
        body: '上部の Input / Review / Analysis / Settings タブで右パネルが切り替わります。入力時は Input、振り返り時は Review。' },
      { title: 'Ctrl+K でコマンドパレット',
        body: 'どこからでも Ctrl+K (Mac: ⌘K) で機能検索。試合切替・選手検索・設定など全部ここから。' },
      { title: '直近 5 ストロークが下端に',
        body: '画面下のヒストリーストリップから直前のストロークにクリックで seek できます。誤入力の修正が速いです。' },
    ],
  },
  analysis_reading: {
    id: 'analysis_reading',
