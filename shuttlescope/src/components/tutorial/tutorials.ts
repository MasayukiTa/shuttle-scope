...
export const TUTORIALS: Record<string, TutorialDef> = {
  ...
  settings_tour: {
    id: 'settings_tour',
    titleKey: 'tutorials.settings_tour._title',
    steps: [
      { titleKey: 'tutorials.settings_tour.welcome.title',
        bodyKey:  'tutorials.settings_tour.welcome.body' },
      { titleKey: 'tutorials.settings_tour.tabs.title',
        bodyKey:  'tutorials.settings_tour.tabs.body',
        target:   '[data-tutorial="settings.tabs"]' },
      { titleKey: 'tutorials.settings_tour.account.title',
        bodyKey:  'tutorials.settings_tour.account.body',
        target:   '[data-tutorial="settings.account"]' },
      { titleKey: 'tutorials.settings_tour.players.title',
        bodyKey:  'tutorials.settings_tour.players.body',
        target:   '[data-tutorial="settings.players"]' },
      { titleKey: 'tutorials.settings_tour.tracknet.title',
        bodyKey:  'tutorials.settings_tour.tracknet.body',
        target:   '[data-tutorial="settings.tracknet"]' },
      { titleKey: 'tutorials.settings_tour.export.title',
        bodyKey:  'tutorials.settings_tour.export.body',
        target:   '[data-tutorial="settings.export"]' },
      { titleKey: 'tutorials.settings_tour.import.title',
        bodyKey:  'tutorials.settings_tour.import.body',
        target:   '[data-tutorial="settings.import"]' },
      { titleKey: 'tutorials.settings_tour.tutorialReplay.title',
        bodyKey:  'tutorials.settings_tour.tutorialReplay.body',
        target:   '[data-tutorial="settings.tutorialReplay"]' },
      { titleKey: 'tutorials.settings_tour.closing.title',
        bodyKey:  'tutorials.settings_tour.closing.body' },
    ],
  },
